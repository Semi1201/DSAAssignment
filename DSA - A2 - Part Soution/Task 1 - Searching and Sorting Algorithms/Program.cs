...
internal class Program
{
    private static void Main(string[] args)
    {
            ...
            do
            {
                //Note to self: Remove console.Clear() to test the program or else it will clear the output before you can see it
                //Console.Clear();
                    ...
                    case 2:
                        {
                            ...
                            {
                                Console.WriteLine($"No oOrder Found Matching ID : {orderID}");
                            }
                        }
                        break;
                    case 3:
